<template>
  ...
  <svg
    ...
    viewBox="0 0 490 490"
    xml:space="preserve"
    class="motion-arrow fill-white h-auto w-8"
  >
    <path
      d="M0,329.246l91.341,93.439l43.124-46.105l34.582,35.377L245,330.76l75.953,81.197l34.582-35.377l43.124,46.105L490,329.246
...
<style scoped>
.motion-arrow {
  animation: side-bounce 1s infinite;
}
